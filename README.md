...
osu-wine --wine <args>: Runs wine + your arguments as if it was normal wine inside osu's wineprefix
...
osu-wine --fixprefix: Reinstalls the osu! Wineprefix from system (add --redl to redownload the prebuilt prefix instead of recreating it)
