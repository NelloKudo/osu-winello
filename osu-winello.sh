...
function install()
{
    ...
    sudo dnf install -y wine || Info "Wine wasn't found in repos, if you're on Nobara you'll be fine regardless xD"
    Info "Dependencies done, skipping.."
    fi
